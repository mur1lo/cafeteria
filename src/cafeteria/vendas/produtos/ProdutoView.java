...
public class ProdutoView extends JInternalFrame {
    ...
    protected void onClickPesquisar() {
        try {
            if (id.getText().isEmpty()) {
                JOptionPane.showMessageDialog(this, "Informe o ID do produto!", "Erro", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            medida.setSelectedItem(produto.getUnidadeMedida());
            preco.setValue(produto.getPreco());
            estoque.setText(String.valueOf(produto.getEstoque()));
            Boolean isEstoque = produto.getEstoque() > 0;
            temEstoque.setSelected(isEstoque);
            estoque.setEnabled(isEstoque);
    ...
    protected void onClickSalvar() {
        try {
            if (nome.getText().isEmpty() || preco.getValue() == null || estoque.getText().isEmpty()) {
    ...
    protected void onClickAtualizar() {
        try {
            if (id.getText().isEmpty() || nome.getText().isEmpty() || preco.getValue() == null || estoque.getText().isEmpty()) {
                JOptionPane.showMessageDialog(this, "Preencha todos os campos!", "Erro", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            JOptionPane.showMessageDialog(this, "ID ou Estoque inválido!", "Erro", JOptionPane.ERROR_MESSAGE);
        } catch (Exception e) {
